            ...
            <div class="row">
                <div class="col-xxl-5 col-xl-6 col-md-9 col-lg-7 m-auto">
                    ...
                    <div class="wsus__login_area">
                        <p class="text-muted">{{ __('Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.') }}
                        </p>
                        ...
                        <p class="create_account">{{ __('Have an account') }} ? <a
